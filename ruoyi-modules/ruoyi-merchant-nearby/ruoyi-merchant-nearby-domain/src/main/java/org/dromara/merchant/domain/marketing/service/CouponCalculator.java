...
public class CouponCalculator implements PriceCalculator {
    ...
    public CalculationResult calculate(List<Product> products, CalculationContext context) {
        ...
        // 添加总优惠金额到上下文中
        context.setCouponDiscountAmount(couponDiscountTotal);
