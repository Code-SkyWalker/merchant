...
public interface CouponSpuConvertor {
     ...
     * @return CouponSpu列表
     */
    List<org.dromara.merchant.domain.marketing.model.CouponSpu> toEntity(List<CouponDO> couponDOList);
     ...
     */
    List<CouponSpuDO> toDO(List<org.dromara.merchant.domain.marketing.model.CouponSpu> couponSpuList);
     ...
     * @return CouponSpu列表
     */
    List<org.dromara.merchant.domain.marketing.model.CouponSpu> cmdToEntity(List<CouponSpu> couponSpuList);
