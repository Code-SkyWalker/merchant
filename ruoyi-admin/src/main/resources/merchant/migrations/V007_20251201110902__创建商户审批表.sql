DROP TABLE IF EXISTS tb_merchant_certify;
CREATE TABLE `tb_merchant_certify` (
  ...
  `legal_person_id_number` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '法人身份证号',
  ...
  `certified_type` char(1) DEFAULT '0' COMMENT '审批类型: 0入驻审批 1修改审批',
  `approval_status` varchar(128) DEFAULT 'PENDING' COMMENT '审批状态: PENDING待审批 APPROVED审批通过 REJECTED审批拒绝 ',
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='商户审批表'